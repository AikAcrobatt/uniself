...
namespace uns::context {

    //интерфейс диспетчера контекста
    template<typename context_t, typename context_generator_t, typename context_constructor_t = context_generator_t>
    ...
    public:
        ...
        virtual std::string Settle(const context_generator_t& context_constructor) = 0;                                                   //Устанавливает валидный контекст на основе конструктора контекста
    ...
    template<typename context_t, typename context_generator_t, typename context_constructor_t = context_generator_t>
    class singlethread_manager : public uns::context::manager_interface<context_t, context_generator_t, context_constructor_t>
    {
    protected:
        context_t* ctx;
    public:
        singlethread_manager() noexcept { ctx = new context_t; };
        ...
        ~singlethread_manager() noexcept { delete ctx; };
    protected:
    ...
    public:
        ...
        virtual bool Valid() const override { return ctx != nullptr && ctx->Valid(); };

        virtual std::string Settle(const context_generator_t& context_constructor) {
    ...
    template<typename context_t, typename context_generator_t, typename context_constructor_t = context_generator_t>
    class multithread_manager : public uns::context::manager_interface<context_t, context_generator_t, context_constructor_t>
    {
    protected:
    ...
    public:
        ...
        std::string Settle(const context_generator_t& context_constructor) override {
