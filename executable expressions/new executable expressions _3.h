...
namespace uns::syntax {
    ...
    public:
        ...
        virtual type_t& Exec(base_t::cash_t& var_cash) override { 
            auto res = std::any_cast<type_t>(var_cash[ref]);
            return res;
        };
    ...
    public:
        ...
        virtual return_t& Exec(base_t::cash_t& var_cash) override { return base_t::subnodes[0]->Exec(var_cash) = base_t::subnodes[1]->Exec(var_cash); };
