...
BOOST_AUTO_TEST_SUITE(string_cast_testing)
    ...
    BOOST_AUTO_TEST_SUITE(bools)
        ...
        BOOST_DATA_TEST_CASE(stdstring_to_bool_correct,
            ...
            BOOST_TEST(out_val == uns::string::u8_cast<bool>(uns::string::u8_cast<std::u8string>(in_str)));
        };
        ...
        BOOST_DATA_TEST_CASE(bool_to_stdstring_correct,
            ...
            BOOST_TEST(out_str == uns::string::u8_cast<std::string>(uns::string::u8_cast<std::u8string>(in_val)));
        };
        ...
        BOOST_DATA_TEST_CASE(backward_identical_cast,
            ...
            BOOST_TEST(the_str == uns::string::u8_cast<std::string>(uns::string::u8_cast<std::u8string>(uns::string::u8_cast<bool>(uns::string::u8_cast<std::u8string>(the_str)))));
        };
    ...
    BOOST_AUTO_TEST_SUITE(integers)
        ...
        BOOST_AUTO_TEST_SUITE(decimals)
            ...
            BOOST_DATA_TEST_CASE(dec_to_stdstring_correct,
                ...
                BOOST_TEST(
                    out_str == uns::string::u8_cast<std::string>(returned)/*,
            ...
            BOOST_DATA_TEST_CASE(backward_identical_cast,
                ...
                BOOST_TEST(the_str == uns::string::u8_cast<std::string>(uns::string::u8_cast<std::u8string>(uns::string::u8_cast<long long int>(uns::string::u8_cast<std::u8string>(the_str)))));
            };
    ...
    BOOST_AUTO_TEST_SUITE(floating_points)
        ...
        BOOST_AUTO_TEST_SUITE(doubles)
            ...
            BOOST_DATA_TEST_CASE(backward_identical_cast,
                ...
                BOOST_TEST(the_str == uns::string::u8_cast<std::string>(uns::string::u8_cast<std::u8string>(uns::string::u8_cast<double>(uns::string::u8_cast<std::u8string>(the_str)))));
            };
