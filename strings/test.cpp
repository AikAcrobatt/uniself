...
BOOST_AUTO_TEST_SUITE(string_cast_testing_integers)
    ...
    BOOST_AUTO_TEST_SUITE(string_cast_testing_decimals)
        ...
        BOOST_DATA_TEST_CASE(string_cast_stdstring_to_dec_correct,
        ...
        BOOST_DATA_TEST_CASE(string_cast_stdstring_to_dec_incorrect,
    ...
    BOOST_AUTO_TEST_SUITE(string_cast_testing_hexadecimals)
        ...
        BOOST_DATA_TEST_CASE(string_cast_stdstring_to_hex_correct,
        ...
        BOOST_DATA_TEST_CASE(string_cast_stdstring_to_hex_incorrect,
    ...
    BOOST_AUTO_TEST_SUITE(string_cast_testing_binaries)

        BOOST_DATA_TEST_CASE(string_cast_stdstring_to_bin_correct,
        ...
        BOOST_DATA_TEST_CASE(string_cast_stdstring_to_bin_incorrect,
