...
namespace uns {
	namespace nn {
		...
		template<typename signal_t>
		std::shared_ptr<uns::nn::activator<signal_t>> StringToActivator(const uns::nn::string_t& str); /*введены отдельно вместо string_cast, изза того что они должны быть шаблонами от signal_t*/


		//Функция конвертации строки в коллектор нейрона
		template<typename signal_t>
		std::shared_ptr<uns::nn::collector<signal_t>> StringToCollector(const uns::nn::string_t& str);
		...
		uns::nn::string_t Type(const uns::nn::activator<signal_t>& Activator, const uns::nn::collector<signal_t>& Collector) {
			return Activator.Type() + uns::string_cast<string_t>("_") + Collector.Type();
		};
		...
		public:
			...
			virtual string_t String() const noexcept {
				...
				string_t res = uns::string_cast<string_t>("[(");
				for (auto link : links)
					res += uns::string_cast<string_t>(link.first) + uns::string_cast<string_t>(",") + uns::string_cast<string_t>(link.second) + uns::string_cast<string_t>(";");
				res += uns::string_cast<string_t>(")");
				for (auto param : params)
					res += uns::string_cast<string_t>(param) + uns::string_cast<string_t>(",");
				res += uns::string_cast<string_t>("(") + uns::string_cast<string_t>(r) + uns::string_cast<string_t>(",") + uns::string_cast<string_t>(s) + uns::string_cast<string_t>(")]");
			...
			virtual bool Set(const string_t& str) {
				...
				if (!uns::string::SeekerSet<string_t>(str, seeker, uns::string_cast<string_t>("[("), false, -1, uns::string_cast<string_t>("]"))) return false;
				string_t temp = string_t();
				string_t temp1 = string_t();
				links.clear();
				do {
					if (!uns::string::SeekerRead<string_t>(str, seeker, temp, uns::string_cast<string_t>(","), false, -1, uns::string_cast<string_t>(")"))) break;
					else if (!uns::string::SeekerRead<string_t>(str, seeker, temp1, uns::string_cast<string_t>(";"), false, -1, uns::string_cast<string_t>(")"))) break;
					else {
						links.push_back(std::pair<int, signal_t>(uns::string_cast<int>(temp), uns::string_cast<signal_t>(temp1)));
					};
				} while (true);
				...
				if (!uns::string::SeekerSet<string_t>(str, seeker, uns::string_cast<string_t>("("), false, -1, uns::string_cast<string_t>("]"))) return false;
				if (!uns::string::SeekerRead<string_t>(str, seeker, temp, uns::string_cast<string_t>(","), false, -1, uns::string_cast<string_t>(")"))) return false;
		...
		public:
			...
			virtual string_t String() const noexcept override {
				...
				res += uns::string_cast<string_t>("[_(");
				for (auto _link : _links) {
					res += uns::string_cast<string_t>(_link.first) + uns::string_cast<string_t>(",") + uns::string_cast<string_t>(_link.second) + uns::string_cast<string_t>(";");
				};
				res += uns::string_cast<string_t>(")");
				res += uns::string_cast<string_t>("(") + uns::string_cast<string_t>(_r)
					+ uns::string_cast<string_t>(",") + uns::string_cast<string_t>(_s)
					+ uns::string_cast<string_t>(",") + uns::string_cast<string_t>(Dropout())
					+ uns::string_cast<string_t>(",") + uns::string_cast<string_t>(is_learning) + uns::string_cast<string_t>(")]");
			...
			virtual bool Set(const string_t& str) override {
				...
				string_t::size_type seeker = 0;
				if (!uns::string::SeekerSet<string_t>(str, seeker, uns::string_cast<string_t>("[_("), false, -1)) return false;
				...
				do {
					if (!uns::string::SeekerRead<string_t>(str, seeker, temp, uns::string_cast<string_t>(","), false, -1, uns::string_cast<string_t>(")"))) break;
						...
						_links.push_back(std::pair<int, int>(uns::string_cast<int>(temp), uns::string_cast<int>(temp1)));
					};
				} while (true);
		...
		public:
			...
			string_t String(size_t first_neuron_number, size_t& last_neuron_number, string_t delimiter = uns::string_cast<string_t>("\n")) const {
				string_t res = uns::string_cast<string_t>("LAYER ") + uns::nn::Type(activator_type, collector_type) + uns::string_cast<string_t>(":") + delimiter;
				for (auto neuron : neurons)
					res += uns::string_cast<string_t>(first_neuron_number++) + uns::string_cast<string_t>(" ") + neuron.String() + delimiter;
				res += uns::string_cast<string_t>(":LAYER");
				last_neuron_number = first_neuron_number;
			...
			bool Set(const string_t& str, string_t delimiter) {
				string_t::size_type seeker = 0;
				if (!uns::string::SeekerSet<string_t>(str, seeker, uns::string_cast<string_t>("LAYER "), false, -1)) return false;
				string_t temp = string_t();
				if (!uns::string::SeekerRead<string_t>(str, seeker, temp, uns::string_cast<string_t>(":") + delimiter, false, -1, uns::string_cast<string_t>(":LAYER"))) return false;
				else std::tie(activator_type, collector_type) = Type(temp);

				neurons.clear();
				do {
					if (!uns::string::SeekerRead<string_t>(str, seeker, temp, delimiter, false, -1, uns::string_cast<string_t>(":LAYER"))) break;
		...
		public:
			...
			string_t String(string_t delimiter = uns::string_cast<string_t>("\n")) const {
				size_t neuron_number = 0;
				string_t res = uns::string_cast<string_t>("NETWORK:") + delimiter;
				for (auto layer : layers)
					res += layer.String(neuron_number, neuron_number, delimiter) + uns::string_cast<string_t>(";") + delimiter;
				res += uns::string_cast<string_t>("OUTPUTS:");
				for (auto output : outputs)
					res += uns::string_cast<string_t>(output) + uns::string_cast<string_t>(",");
				res += uns::string_cast<string_t>(":OUTPUTS") + delimiter;
				res += uns::string_cast<string_t>("PARAMS:");
				for (auto common_param : common_params)
					res += uns::string_cast<string_t>(common_param) + uns::string_cast<string_t>(",");
				res += uns::string_cast<string_t>(":PARAMS") + delimiter;
				res += uns::string_cast<string_t>(":NETWORK");
			...
			bool Set(const string_t& str, string_t delimiter) {
				string_t::size_type seeker = 0;
				if (!uns::string::SeekerSet<string_t>(str, seeker, uns::string_cast<string_t>("NETWORK:") + delimiter, false, -1)) return false;

				string_t temp = string_t();
				layers.clear();
				do {
					if (!uns::string::SeekerRead<string_t>(str, seeker, temp, uns::string_cast<string_t>(";") + delimiter, false, -1, uns::string_cast<string_t>("OUTPUTS:"))) break;
					else layers.push_back(layer_representation<neuron_representation_t>(temp, delimiter));
				} while (true);

				if (!uns::string::SeekerSet<string_t>(str, seeker, uns::string_cast<string_t>("OUTPUTS:"), false, -1)) return false;
				temp = string_t();
				outputs.clear();
				do {
					if (!uns::string::SeekerRead<string_t>(str, seeker, temp, uns::string_cast<string_t>(","), false, -1, uns::string_cast<string_t>(":OUTPUTS"))) break;
					else outputs.push_back(uns::string_cast<size_t>(temp));
				} while (true);

				if (!uns::string::SeekerSet<string_t>(str, seeker, uns::string_cast<string_t>("PARAMS:"), false, -1)) return false;
				temp = string_t();
				common_params.clear();
				do {
					if (!uns::string::SeekerRead<string_t>(str, seeker, temp, uns::string_cast<string_t>(","), false, -1, uns::string_cast<string_t>(":PARAMS"))) break;
		...
		decltype(auto) cast(const network_representation_in_t& repr) {
		...
		public:
			...
			int Index() const noexcept override { return -static_cast<int>(num_of_cell); };
			...
			void Set(int num_of_input, const input_data_object_interface<signal_t>& ido) noexcept {
				...
				else num_of_cell = static_cast<size_t>(-num_of_input);
			...
			for (auto& layer : repr.layers) {
				for (auto neuron : layer.neurons) {
					...
					*(next_neuron->S) = neuron.s;
					...
					next_neuron->Index(static_cast<int>(neurons.size()));
			...
			for (auto& layer : repr.layers) {
				for (auto neuron : layer.neurons) {
					for (auto link : neuron.links)
						if (link.first < 0) {
							input_number = static_cast<size_t>(-link.first);
							...
							if (input_neurons_numbers[input_number] == empty_meaning) {
								...
								input_neurons_numbers[input_number] = static_cast<int>(base_t::inputs.size() - 1);
							};
							if (input_neurons_numbers[input_number] > empty_meaning)
								neurons[neuron_number]->links.push_back(std::pair<neuron_interface<signal_t>*, signal_t>(dynamic_cast<neuron_interface<signal_t>*>(base_t::inputs[static_cast<size_t>(input_neurons_numbers[input_number])]), link.second));
						}
						else if (link.first < neurons.size())
							neurons[neuron_number]->links.push_back(std::pair<neuron_t*, signal_t>(neurons[static_cast<size_t>(link.first)], link.second));
					neuron_number++;
				};
			};
