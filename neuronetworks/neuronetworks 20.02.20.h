...
namespace uns {
	namespace nn {
		...
		public:
			...
			signal_t dS_dw(size_t layer_index, size_t neuron_idx, size_t weight_idx) const { return base_t::layers[layer_index][neuron_idx]->dS_dw(weight_idx); };
			signal_t dS_dp(size_t layer_index, size_t neuron_idx, size_t param_idx) const { return base_t::layers[layer_index][neuron_idx]->dS_dp(param_idx); };
			signal_t dF_dp(size_t layer_index, size_t neuron_idx, size_t param_idx) const { return base_t::layers[layer_index][neuron_idx]->dF_dp(param_idx); };
		};
