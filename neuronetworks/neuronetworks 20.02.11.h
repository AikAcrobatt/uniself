...
namespace uns {
	...
	namespace nn {
		...
		class nonrecursive_neuron : public neuron_interface<signal_t> {
			friend nonrecursive_network<nonrecursive_neuron<signal_t>>;
		protected:
	...
	namespace nn {
		...
		template<class neuron_t>
		class nonrecursive_network : public network_interface<typename neuron_t::neuron_signal_t> {
		protected:
		...
		public:
			...
			nonrecursive_network(const nonrecursive_network<neuron_t>& net) = delete;
			nonrecursive_network<neuron_t> operator=(const nonrecursive_network<neuron_t>& net) = delete;
			nonrecursive_network(nonrecursive_network<neuron_t>&& net) = delete;
			nonrecursive_network<neuron_t> operator=(nonrecursive_network<neuron_t>&& net) = delete;
			~nonrecursive_network() {
				for (auto& neuron : neurons)
					delete neuron;
		...
		template<class neuron_t>
		inline void nonrecursive_network<neuron_t>::Set(const uns::nn::network_representation<neuron_representation<signal_t>>& repr, const uns::nn::input_data_object_interface<signal_t>* const ido) {
			...
			for (auto neuron : repr.neurons) {
				...
				next_neuron->F = uns::StringToActivator<signal_t>(neuron.activator_type);
				next_neuron->S = uns::StringToCollector<signal_t>(neuron.collector_type);
		...
		template<class neuron_t>
		inline network_representation<neuron_representation<typename neuron_t::neuron_signal_t>> nonrecursive_network<neuron_t>::Represent() {
		...
		template<typename signal_t>
		class nonrecursive_reverse_network : public nonrecursive_network<uns::nn::nonrecursive_reverse_neuron<signal_t>> {
		protected:
			using neuron_t = uns::nn::nonrecursive_reverse_neuron<signal_t>;
			using base_t = nonrecursive_network<neuron_t>;
