...
namespace uns {
	namespace nn {
		...
		template<typename signal_t>
		uns::nn::string_t activator_cast(const std::shared_ptr<uns::nn::activator<signal_t>>& obj) {
			return obj->Type();
		};
		...
		template<typename signal_t>
		uns::nn::string_t collector_cast(const std::shared_ptr<uns::nn::collector<signal_t>>& obj) {
			return obj->Type();
		};
